      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '13px', color: 'var(--gray-600)', lineHeight: '1.6', marginBottom: '20px' }}>
            To link the storefront, user portal, and admin portal to a real-time database, please execute the database schema below in your Supabase project's <strong>SQL Editor</strong>.
          </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <p style={{ fontSize: '12px', color: 'var(--gray-600)', marginBottom: '24px' }}>
            Once you create your Supabase project, paste the connection parameters below to initialize the app.
          </p>
